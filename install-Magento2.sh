#!/bin/bash
#This script will install Magento 2 and all it's dependencies (nginx, php-fpm, mysql, redis).
...
M2SETUP_DOMAIN=${M2SETUP_DOMAIN:-linuxtm.ro}
...
read -p "Magento version (default ${green}2.3.5-p1${no}): " M2SETUP_VERSION
M2SETUP_VERSION=${M2SETUP_VERSION:-2.3.5-p1}
